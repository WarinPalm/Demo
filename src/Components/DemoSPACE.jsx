...
function DemoSPACE() {
  const [pageNumber, setPageNumber] = useState(1); // เริ่มต้นที่หน้าแรก
    ...
    return (
      <>
        <section id="demo-space" className="demo-space w-100 vh-100 d-grid justify-content-center align-items-center scrolling-fixed" >
                    ...
                    <div className="col-7">
                        <div className="card bg-transparent border border-light p-5">
                          <div className="card-body">
                            ...
                            Experience the Ultimate Event Space at Demo Space
                            Looking for the perfect venue to host your next unforgettable event, party, or Music Videos? 
                            Look no further than Demo Space, the premier event space that offers unparalleled versatility and style.
                            </div>
                            <hr style={{color:"white"}} />
                          </div>
                        </div>
