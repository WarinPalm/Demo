...
function DemoMETAVERSE() {
  const [pageNumber, setPageNumber] = useState(1); // เริ่มต้นที่หน้าแรก
    ...
    return (
      <>
        <section id="demo-metaverse" className="demo-metaverse w-100 vh-100 d-grid justify-content-center align-items-center scrolling-fixed" >
                ...
                {pageNumber === 1 && (
                  <div className="row">
                    <div className="col-7">
                        <div className="card bg-transparent border border-light p-5">
                          <div className="card-body">
                            ...
                            Revolutionize Your Training Experience with Our VR Solutions on Blockchain.
                            100% Secure, Transparent, and Immersive Learning Environment.
                            Empowering the Future of Training with Decentralized Innovation.
                            </div>
                            <hr style={{color:"white"}} />
                          </div>
                        </div>
                    ...
                    <div className="col-5" style={{ position: "relative" }}>
                      <div className="metaverse-logo"></div>
                      <div className="text-on-metaverse">
